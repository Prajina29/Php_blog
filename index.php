...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <a href="#" class="btn btn-warning ms-4">Login</a>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <footer class="bg-black d-flex flex-row justify-content-between text-light py-5 px-5">
        <div class="ms-4 col">Logo</div>
        <div class="ms-4 col">
            <a href="" class="text-light text-decoration-none">About Us</a>
            <a href="" class="text-light text-decoration-none">TOS</a>
            <a href="" class="text-light text-decoration-none">Privacy Policy</a>
        </div>
        <div class="ms-4">&copy; inttrinix inc, 2024</div>
    </footer>
    <script
